module share
    ...
    REAL(8), parameter :: elasticity= 2.5!3.5 ! intertemporal elasticity of substitution
    REAL(8), parameter :: rentPrem= 7.70e-2!0.015 ! Rental operation costs on top of user cost
    ...
    REAL(8), parameter :: psi= 1 ! End-of-life bequest parameter
    REAL(8), parameter :: rentUtil= .93!.90 ! Disutility of renting relative to owning
