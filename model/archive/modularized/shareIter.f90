module share
    ...
    REAL(8), parameter :: thetamatlab= 1.000000 
    ...
    REAL(8), parameter :: r_rentalO= 0.900000 
    REAL(8), parameter :: r_rental_retireO= r_rentalO
    REAL(8), parameter :: elasticity2O= 0.900000 ! 1 - (share of expenditure in housing)
    ...
    !REAL(8), parameter :: amin= -0.150000 !minimum asset value (actually voluntary equity if theta!= -0.150000 
    ...
    integer, parameter :: PolYrs= 1.000000 ! Number of years subsidy is active
    integer, parameter :: PolYrDiff=0 ! Years btwn Repeat and Homebuyer policies
    integer, parameter :: EligYrsF= 99.000000 ! Years under which agent is not owning to be first-time
    integer, parameter :: EligYrsR= 2.000000 ! Years under which agent owns the same durable to be repeat
    ...
    INTEGER, parameter :: numhouseholds= 15000.000000 !Size of household panel
    ...
    REAL(8), parameter :: rentelasticity= 0.000000 
